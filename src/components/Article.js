...
export default function Article() {
  return (
    <div className="w-full py-8 ">
      ...
      <div className="p-5 m-10" style={{ backgroundColor: "rgba(255, 255, 255, .5)" }}>
        <div className="  article grid grid-cols-1 sm:grid-cols-1 md:grid-cols-4 bg-gray-100 lg:grid-cols-4 xl:grid-cols-4 gap-0">
          <div class="max-w-sm">
            <div>
          ...
          <div class="max-w-sm">
            ...
            <div class="p-5 article-content ">
              ...
              <p class="mb-2 font-normal text-gray-700 dark:text-gray-400">
                ...
                prototyping, collaborating, and creating user-centered
                interfaces in this interactive workshop.
              </p>
              <div class="flex justify-between pt-3 border-t border-gray-300 text-gray-600">
                <p class="text-sm text-grey-400">18.08.2023</p>
                <div class="flex">
